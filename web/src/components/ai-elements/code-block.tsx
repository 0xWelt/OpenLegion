...
export const CodeBlock = ({
  ...
  return (
    <CodeBlockContext.Provider value={{ code: copyText }}>
      <div
        className={cn(
          "group relative w-full rounded border border-oc-border bg-oc-surface text-oc-text",
          className,
        )}
        {...props}
      >
...
// Button component variant styles matching kimi-cli
...
const Button = ({
  ...
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-all disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:ring-2 focus-visible:ring-ring",
        variant === "default" && "bg-primary text-primary-foreground hover:bg-primary/90",
        variant === "ghost" && "hover:bg-oc-surface-hover hover:text-oc-text",
